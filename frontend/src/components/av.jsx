            ...
            {products.map((product) => (
                ...
                >
                    <div className="aspect-[4/5] overflow-hidden rounded-2xl mb-6 bg-emerald-50/30 relative group-hover:shadow-2xl transition-all duration-500">
                        <img
                            src={product.image ? (product.image.startsWith('http') ? product.image : `http://localhost:5000/image/${product.image}`) : 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=800&q=80'}
                            alt={product.name}
